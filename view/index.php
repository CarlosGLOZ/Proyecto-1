...
<br>
<div id="form-filtros">
    <select class="styled-select" id="<?php echo FILTROS['CAPACIDAD'];?>">
        <?php
    ...
    <select class="styled-select" id="<?php echo FILTROS['DISPONIBILIDAD'];?>">
        <?php
    ...
    <button class="btn btn-success" onclick="enviarFiltros('<?php echo $url_base;?>', [<?php echo FILTROS['CAPACIDAD'].', '.FILTROS['DISPONIBILIDAD'] ;?>]);">Filtrar</button>
    <button class="btn btn-danger" onclick="limpiarFiltros('<?php echo $url_base;?>');">Limpiar Filtros</button>
</div>
<!-- /Filtros -->
